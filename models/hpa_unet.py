...
class hpa_unet(object):
    def __init__(self, name = 'hpa_unet', input_shape = (1024, 1024, 4)):
        ...
        self.feature_extractor = arch.model_unet(root_feature = 32, keep_multi_level_features = False)
    ...
    def build(self, trainable = True):
        ...
        self.nn = tf.keras.Model(inputs = x, outputs = outputs, name=self.name, trainable)
